...
if __name__ == "__main__":
    # Delete old database so fresh seed data is generated with current timestamps
    if os.path.exists(DB_FILE):
        os.remove(DB_FILE)
        print("[RESET] Removed old database for fresh seed data.")

    init_db()
    print(f"[START] CampusPulse Server running at http://localhost:8000")
