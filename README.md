...
# Forkathon 2026: [CampusPulse] by Team-CODE_and_CAFFEINE
...
Preference Setup: Right after signing up (or anytime after, from settings), users choose two important things: a noise filter ; how much they want to see (strict, balanced, or all)  and their preferred topics, which we explain next.<br>
